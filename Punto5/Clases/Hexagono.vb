Public Class Hexagono : Inherits Figura
    ...
    Public Sub New(alto As Double, ancho As Double, area As Double, perimetro As Double, tamañoLado1 As Double, tamañoLado2 As Double, tamañoLado3 As Double, tamañoLado4 As Double, tamañoLado5 As Double, tamañoLado6 As Double)
    ...
    Public Function calcularPerimetro()
        perimetro = tamañoLado1 + tamañoLado2 + tamañoLado3 + tamañoLado4 + tamañoLado5 + tamañoLado6
        Return perimetro
    End Function
